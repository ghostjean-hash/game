...
// v209 (2026-08-06): 영어 단어장 "다시 안 보기"를 1차·2차로 나눴다. 1차는 이미 아는 기초 단어라 학습 대상에서 아예 빠지고(완료율 계산에서도 빠진다), 2차는 외운 단어를 복습 목록에서만 내리는 자리라 외운 개수와 완료율은 그대로 남는다. 외운 단어 목록에서 단어마다 또는 한 번에 2차로 넘길 수 있고, "다시 안 볼 단어" 화면이 두 묶음으로 나뉜다. 옛 v208 캐시 폐기.
