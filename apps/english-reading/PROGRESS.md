...
3.1. 약점 진단 리포트 기획서 추가 여부 결정 - 문법 이름표 체계 + 자주 틀리는 단어 + 추이 리포트 제안됨(문법 6종 초안: 주어·동사 찾기 / 관계대명사절 / 대명사 지시 / to부정사·동명사 / 접속사 절 / 시제·수동태·비교). 사용자 결정 대기.
3.2. 기획서 본문 확정 + MVP 착수 전 개발 세부 결정(유추 단어 표시 정도 · 복습 삽입 위치 등).
