...
1.2. **상태**: 앱 기능 완성(회상형 학습·세트 선택 메뉴·세트별 진도·목록 표시 설정·못 외운 단어 모음). 콘텐츠는 초등 4세트(playland/2015 기반, 임시)가 들어가 있으나, **공식 2022 개정 데이터로 교체 진행 중**. **다음 착수 = `docs/NEXT-authoring-batch-01.md`**(공식 초등 800의 BATCH 01 제작). 준비(원천 확보·별표 범례 확정·비교·규칙 확정) 완료, 제작만 남음.
