...
- 2026-07-02: 2모드 추가 - 오리지널(자체 186개) / 보드게임(ThinkFun, `puzzles-boardgame.js`, 임시 6개). 상단바 전환 버튼, 진행·별은 모드별 저장(`progress.modes`), 골드·꾸미기는 공유. 옛 저장 데이터는 `migrateProgress`가 오리지널 모드로 이관
