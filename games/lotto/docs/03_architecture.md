...
│   │   ├── settings-page.js     # 설정 탭 (캐릭터 관리 + 프리셋 관리(S61) + 옵션 + 다구좌 + 휠링 진입 + 면책 + 초기화)
...
~~자동 백캐스트~~ (S090 2026-05-17 폐기 / S093 cleanup 2026-05-18 dead 상수 BACKFILL_RECENT_COUNT 제거)
  → core/history.js backfillRecommendations 함수 자체 삭제 (S090).
