...
첫 진입 / 데이터 손상 / 사용자 reset 시 주입. **S37(2026-05-08, 사행성 책임)** 갱신. **S63(2026-05-10) `subtitle` 필드 제거.**

| id | 라벨 | 묶음 | 자동 표시 (label list) |
|---|---|---|---|
| `preset-1` | 균형 | `trendFollower` + `astrologer` + `intuitive` | 최신 · 별자리 · 직감 |
| `preset-2` | 분산파 | `regressionist` + `intuitive` + `balancer` | 적게 · 직감 · 균형 |
| `preset-3` | 운세파 | `astrologer` + `fiveElements` + `zodiacElement` | 별자리 · 4원소 · 사주 |
