...
1.5.2.5. **운세 카테고리 정직성 (S6-T1 / S10 통합, 2026-05-02)**: 본 카테고리 3종(별자리 / 별자리 4원소 / 일주 오행)의 행운 번호는 **게임 디자이너가 임의로 배정한 콘텐츠**이며, 점성술·명리학 등 외부 학설과 무관하다. UI 노출 위치 3곳 모두 면책 카피 강제:
