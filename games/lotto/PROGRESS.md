...
1.2. **시작**: 2026-05-01.
1.3. **마지막 갱신**: 2026-05-19 (Sprint 094-후속 F+B+ - 휴지통 opacity 0.45 + margin-left 12px = [확정][🗑] 시각 분리).
...
**S095 swipe 진행 판정 데이터**: 본 후속 commit + 캐시 갱신 후 사용자 캡쳐 + 실 사용 평가. 효과 미흡 시 swipe 진행.
