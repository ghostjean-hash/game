...
1.2. **시작**: 2026-05-01.
1.3. **마지막 갱신**: 2026-06-07 (다음 버전 "메인 깔끔화" S0-S4 구현 - 죽은 옵션 제거 / 메인 비우기 / 캐릭터 카드 운세 전면 / 당첨 기원 기록 탭 이동 / 카운트다운 단위. 상세 `BACKLOG.md`. 미커밋 + docs 일치 잔여). 직전 = 2026-05-22 (Sprint 097-후속 6 / 7 + 라벨 마이크로 정정).
