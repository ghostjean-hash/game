...
const STRATEGIES = [
  ...
  { id: STRATEGY_STATISTICIAN, label: '통계 추첨', short: '통', desc: '역대 회차에 가장 많이 나온 번호 위주', category: '통계' },
  { id: STRATEGY_SECOND_STAR, label: '보너스볼 사냥', short: '별', desc: '역대 보너스볼로 자주 나온 번호 위주 (본번호 + 보너스 모두)', category: '통계' },
