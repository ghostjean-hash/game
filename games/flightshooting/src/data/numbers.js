...
export const CFG = {
  ...
  bullet: {
    speed: 620,
    shapes: [
      { rx: 1.0, ry: 2.2, glow: 0 },              // 0 기본(진화 전, 세로 타원)
      { rx: 1.7, ry: 1.7, glow: 5 },              // 1 원(굵은 구슬)
      { rx: 1.5, ry: 2.9, glow: 8 },              // 2 타원(럭비공)
      { rx: 1.2, ry: 3.8, glow: 11 },             // 3 긴형(레이저빔)
      { rx: 1.9, ry: 1.9, glow: 14, ring: 0.5 },  // 4 링(발광 고리, 최종)
    ],
  },
