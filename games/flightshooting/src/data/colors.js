...
export const COLORS = {
  ...
  friend: {
    ...
    // 총알: 밝은 골드/흰색은 눈에 거슬려(사용자 지시) 다크·차분한 흐린 웜톤으로 누름. 여전히 냉색 빔·빨간 적탄과 구분.
    shot: ['#9c7a4a', '#8f6f42', '#a3805a', '#8a6a4e', '#9a7060', '#8a6360', '#9c8070', '#7f6f50', '#8f7e5e', '#9e8e6e', '#b0a080'],
    shotCore: '#cbb892', // 코어 점(흰색 대신 흐린 밝은 톤 - 눈부심 제거)
  },
};
